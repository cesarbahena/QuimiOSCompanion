...
class Driver:
    ...
    def __init__(self, lis: LIS, user: User, maximized: bool = False) -> None:
        self.lis = lis
        self.user = user()
        ...
        try:
            ...
            print('\nNecesitas descargar la version de Chromedriver compatible con tu versión de Chrome y colocarlo en la carpeta de este programa')
            exit()
